...
#LLVM_CFLAGS does not include the path to the llvm-c headers on Ubuntu, fix this
find_path(LLVMC_INCLUDE_DIR
    NAMES llvm-c
    PATH_SUFFIXES llvm-c-${LLVM_VERSION_MAJOR}.${LLVM_VERSION_MINOR}
    DOC "LLVM-C header location"
)

if(LLVMC_INCLUDE_DIR)
    LIST(APPEND LLVM_INCLUDE_DIRS ${LLVMC_INCLUDE_DIR})
#    SET(LLVM_INCLUDE_DIRS ${LLVM_INCLUDE_DIRS} ${LLVMC_INCLUDE_DIR})
    UNSET(LLVMC_INCLUDE_DIR)
endif()
